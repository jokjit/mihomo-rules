...
const main = (config) => {
  ...
  "https://dns.alidns.com", // 阿里DoH
  "https://doh.pub/dns-query", // 腾讯DoH
  "https://dns.18bit.cn"  // 18bit（DoH）
  ];
  ...
  "https://dns.google/dns-query",       // Google (广泛可用)
  ];
...
const socialGroups = createGroups([
  ...
  ["Twitch", "https://images.icon-icons.com/3041/PNG/512/twitch_logo_icon_189242.png"],
  ...
  ["PikPak", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7-zJG_Jscmb1sqcdzDoxmYVhSqHqC5H-8gFSzZDp0bw&s=10"],
  ...
  ["LINE", "https://images.icon-icons.com/1099/PNG/512/1485482196-line_78675.png"],
  ["Signal", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7QoT7Zw7IEC_Kn1Hq1ClLy2ap-PEMWAFTO184F5RVMw&s=10"],
  ["Wise", "https://cdn.jsdmirror.com/gh/jokjit/mihomo-rules@main/icon/Wise.png"],
  ["BT追踪器", "https://images.icon-icons.com/2428/PNG/512/bittorrent_black_logo_icon_147155.png"],
...
const regionGroups = [
  ...
  config["rule-providers"] = {
    ...
    "AppleTV": {
      ...ruleProviderCommon,
      "behavior": "domain",
      "url": "https://jsd.onmicrosoft.cn/gh/peiyingyao/Rule-for-OCD@master/rule/Clash/AppleTV/AppleTV_OCD_Domain.mrs",
    ...
    "Spotify": {
      ...ruleProviderCommon,
      "behavior": "domain",
      "url": "https://cdn.jsdmirror.com/gh/MetaCubeX/meta-rules-dat@meta/geo/geosite/spotify.mrs",
